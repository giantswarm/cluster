...
- Monitoring: Add ServiceMonitor for blackbox exporter to probe the workload cluster API server `/readyz` endpoint from the management cluster. Configurable via `providerIntegration.monitoring.apiServerProbe`.
