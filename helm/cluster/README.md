...
| `providerIntegration.resourcesApi.externalAutoscalerEnabled` | **External autoscaler enabled** - Flag that indicates if an external (to CAPI) autoscaler is used.|**Type:** `boolean`<br/>**Default:** `true`|
