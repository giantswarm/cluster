...
| `providerIntegration.workers.kubeadmConfig.enable` | **Enable kubeadm config** - Flag that indicates if the kubeadm config should be rendered.|**Type:** `boolean`<br/>**Default:** `true`|
