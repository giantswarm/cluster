...
| `providerIntegration.teleport` | **Teleport** - Teleport configuration for cluster access|**Type:** `[object]`<br/>**Default:** `{"autoUpdate":{"enabled":false,"intervalSec":"1h","manualVersionOverride":"","onBootDelaySec":"5min","randomizedDelaySec":"10min","timeoutSeconds":600},"enabled":true,"initialJoinToken":"","proxyAddr":"teleport.giantswarm.io:443","version":"16.5.12"}`|
| `providerIntegration.teleport.autoUpdate` | **Teleport Auto-Update Configuration** - Configuration for automatic Teleport binary updates|**Type:** `[object]`<br/>**Default:** `{"enabled":false,"intervalSec":"1h","manualVersionOverride":"","onBootDelaySec":"5min","randomizedDelaySec":"10min","timeoutSeconds":600}`|
| `providerIntegration.teleport.autoUpdate.enabled` | **Enable auto-update** - Enable automatic updates of the Teleport binary to match cluster version|**Type:** `[boolean]`<br/>**Default:** `false`|
| `providerIntegration.teleport.autoUpdate.intervalSec` | **Update interval** - How often to check for updates (systemd time format, e.g., '1h', '30m')|**Type:** `[string]`<br/>**Default:** `"1h"`|
| `providerIntegration.teleport.autoUpdate.manualVersionOverride` | **Manual version override** - Manually specify target version if dynamic detection fails (e.g., '16.5.12'). Leave empty to rely on dynamic detection.|**Type:** `[string]`<br/>**Default:** `""`|
| `providerIntegration.teleport.autoUpdate.onBootDelaySec` | **Boot delay** - Delay after boot before first update check (systemd time format)|**Type:** `[string]`<br/>**Default:** `"5min"`|
| `providerIntegration.teleport.autoUpdate.randomizedDelaySec` | **Randomized delay** - Random delay to spread update checks across nodes (systemd time format)|**Type:** `[string]`<br/>**Default:** `"10min"`|
| `providerIntegration.teleport.autoUpdate.timeoutSeconds` | **Update timeout** - Timeout for update operations in seconds|**Type:** `[integer]`<br/>**Default:** `600`|
