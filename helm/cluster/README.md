...
| `providerIntegration.resourcesApi.controlPlaneResource.provider` | **Provider** - The control plane provider to use (e.g., kubeadm, kamaji). Only required when enabled is true.|**Type:** `string`<br/>**Allowed values:** `kubeadm`, `external`, `kamaji`<br/>|
