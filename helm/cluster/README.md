...
| `providerIntegration.resourcesApi.externalAutoscaler` | **External autoscaler** - Configuration for external autoscaler.|**Type:** `object`<br/>|
| `providerIntegration.resourcesApi.externalAutoscaler.enabled` | **Enabled** - Flag that indicates if an external (to CAPI) autoscaler is used.|**Type:** `boolean`<br/>**Default:** `true`|
