...
| **Property** | **Description** | **More Details** |
| :----------- | :-------------- | :--------------- |
| `global.components.audit` | **Audit** - Enable Audit rules service.|**Type:** `object`<br/>|
| `global.components.audit.enabled` | **Enabled** - Whether or not the Audit rules service shall be enabled. When true, the Audit rules service is enabled. When false, the Audit rules service is disabled.|**Type:** `boolean`<br/>**Default:** `false`|
