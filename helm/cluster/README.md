...
| `providerIntegration.controlPlane.kubeadmConfig.clusterConfiguration.apiServer.cloudConfig` | **cloudf config** - The path of the cloud config file.|**Type:** `string`<br/>|
