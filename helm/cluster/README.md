...
| `providerIntegration.resourcesApi.controlPlaneResource.provider` | **Provider** - The control plane provider to use (e.g., kubeadm, kamaji).|**Type:** `string`<br/>**Allowed values:** `kubeadm`, `kamaji`<br/>**Default:** `"kubeadm"`|
