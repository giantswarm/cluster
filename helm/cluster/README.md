...
| `providerIntegration.bastion.kubeadmConfig.ignition.containerLinuxConfig.additionalConfig.systemd.units[*].contents.service.environment` | **Environment** - systemd service Environment.|**Type:** `string`<br/>|
...
| `providerIntegration.controlPlane.kubeadmConfig.ignition.containerLinuxConfig.additionalConfig.systemd.units[*].contents.service.environment` | **Environment** - systemd service Environment.|**Type:** `string`<br/>|
...
| `providerIntegration.kubeadmConfig.ignition.containerLinuxConfig.additionalConfig.systemd.units[*].contents.service.environment` | **Environment** - systemd service Environment.|**Type:** `string`<br/>|
...
| `providerIntegration.workers.kubeadmConfig.ignition.containerLinuxConfig.additionalConfig.systemd.units[*].contents.service.environment` | **Environment** - systemd service Environment.|**Type:** `string`<br/>|
