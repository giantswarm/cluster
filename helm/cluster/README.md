...
| `providerIntegration.workers.kubeadmConfig.disable` | **Disable kubeadm config** - Flag that indicates if the kubeadm config should not be rendered.|**Type:** `boolean`<br/>|
