...
| `global.apps.giantswarmClusterSuite.extraConfigs[*].kind` | **Kind** - Specifies whether the resource is a config map or a secret.|**Type:** `string`<br/>**Allowed values:** `configMap`, `ConfigMap`, `secret`, `Secret`<br/>|
...
| `internal.advancedConfiguration.controlPlane.apiServer.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `internal.advancedConfiguration.controlPlane.controllerManager.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `internal.advancedConfiguration.controlPlane.scheduler.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `internal.advancedConfiguration.kubelet.evictionHard` | **Hard eviction thresholds** - Thresholds at which the kubelet evicts pods immediately, without a grace period. These are subtracted from the node's allocatable resources.|**Type:** `object`<br/>|
| `internal.advancedConfiguration.kubelet.evictionHard.imagefsAvailable` | **Hard eviction threshold for available image filesystem space** - Maps to the kubelet's `imagefs.available` hard eviction signal. Absolute value (e.g. "1Gi") or percentage (e.g. "15%").|**Type:** `string`<br/>**Default:** `"15%"`|
| `internal.advancedConfiguration.kubelet.evictionHard.memoryAvailable` | **Hard eviction threshold for available memory** - Maps to the kubelet's `memory.available` hard eviction signal. Absolute value (e.g. "200Mi") or percentage (e.g. "5%").|**Type:** `string`<br/>**Default:** `"200Mi"`|
...
| `internal.advancedConfiguration.kubelet.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `providerIntegration.apps.certManagerCrossplaneResources` | **Provider integration app config** - App config used to additionally configure an app for a specific provider|**Type:** `object`<br/>|
| `providerIntegration.apps.certManagerCrossplaneResources.configTemplateName` | **Config template name** - Name of the Helm template that has provider-specific app config. Provider-specific app config overrides provider-independent app config, while custom user config overrides both provider-independent and provider-specific default app config.|**Type:** `string`<br/>|
| `providerIntegration.apps.certManagerCrossplaneResources.enable` | **Enable** - Flag that indicates if an app is enabled for a provider. It is false by default, which allows for more incremental and safer adoption of the cluster chart.|**Type:** `boolean`<br/>**Default:** `false`|
...
| `providerIntegration.apps.clusterAutoscalerCrossplaneResources` | **Provider integration app config** - App config used to additionally configure an app for a specific provider|**Type:** `object`<br/>|
| `providerIntegration.apps.clusterAutoscalerCrossplaneResources.configTemplateName` | **Config template name** - Name of the Helm template that has provider-specific app config. Provider-specific app config overrides provider-independent app config, while custom user config overrides both provider-independent and provider-specific default app config.|**Type:** `string`<br/>|
| `providerIntegration.apps.clusterAutoscalerCrossplaneResources.enable` | **Enable** - Flag that indicates if an app is enabled for a provider. It is false by default, which allows for more incremental and safer adoption of the cluster chart.|**Type:** `boolean`<br/>**Default:** `false`|
| `providerIntegration.apps.clusterProbes` | **Provider integration app config** - App config used to additionally configure an app for a specific provider|**Type:** `object`<br/>|
| `providerIntegration.apps.clusterProbes.configTemplateName` | **Config template name** - Name of the Helm template that has provider-specific app config. Provider-specific app config overrides provider-independent app config, while custom user config overrides both provider-independent and provider-specific default app config.|**Type:** `string`<br/>|
| `providerIntegration.apps.clusterProbes.enable` | **Enable** - Flag that indicates if an app is enabled for a provider. It is false by default, which allows for more incremental and safer adoption of the cluster chart.|**Type:** `boolean`<br/>**Default:** `false`|
...
| `providerIntegration.apps.externalDnsCrossplaneResources` | **Provider integration app config** - App config used to additionally configure an app for a specific provider|**Type:** `object`<br/>|
| `providerIntegration.apps.externalDnsCrossplaneResources.configTemplateName` | **Config template name** - Name of the Helm template that has provider-specific app config. Provider-specific app config overrides provider-independent app config, while custom user config overrides both provider-independent and provider-specific default app config.|**Type:** `string`<br/>|
| `providerIntegration.apps.externalDnsCrossplaneResources.enable` | **Enable** - Flag that indicates if an app is enabled for a provider. It is false by default, which allows for more incremental and safer adoption of the cluster chart.|**Type:** `boolean`<br/>**Default:** `false`|
...
| `providerIntegration.apps.rbacBootstrap` | **Provider integration app config** - App config used to additionally configure an app for a specific provider|**Type:** `object`<br/>|
| `providerIntegration.apps.rbacBootstrap.configTemplateName` | **Config template name** - Name of the Helm template that has provider-specific app config. Provider-specific app config overrides provider-independent app config, while custom user config overrides both provider-independent and provider-specific default app config.|**Type:** `string`<br/>|
| `providerIntegration.apps.rbacBootstrap.enable` | **Enable** - Flag that indicates if an app is enabled for a provider. It is false by default, which allows for more incremental and safer adoption of the cluster chart.|**Type:** `boolean`<br/>**Default:** `false`|
...
| `providerIntegration.components.containerd.sandboxContainerImage.tag` | **Tag**|**Type:** `string`<br/>**Default:** `"3.10.1"`|
...
| `providerIntegration.controlPlane.kubeadmConfig.clusterConfiguration.apiServer.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `providerIntegration.controlPlane.kubeadmConfig.clusterConfiguration.controllerManager.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `providerIntegration.controlPlane.kubeadmConfig.clusterConfiguration.scheduler.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `providerIntegration.controlPlane.kubeadmConfig.postKubeadmCommandsTemplateName` | **Post-kubeadm commands template name** - The name of the Helm template that renders additional provider-specific commands to run after kubeadm on control plane nodes. The template is rendered once for the control plane. It must render a YAML list of strings, one command per item.|**Type:** `string`<br/>|
...
| `providerIntegration.kubeadmConfig.featureGates[*].maxKubernetesVersion` | **Maximum Kubernetes version** - Optional maximum Kubernetes version allowed for this feature gate to be functional. Uses semantic versioning (e.g., '1.33.0'). If specified and the cluster version is above this threshold, the feature gate will be ignored.|**Type:** `string`<br/>**Value pattern:** `^\d+\.\d+\.\d+$`<br/>|
...
| `providerIntegration.resourcesApi.machinePoolResources` | **Machine pool resources** - Configuration for machine pool resources. This is meant only for the initial development purposes for the sake of incrementally integrating cluster chart into cluster-$provider apps.|**Type:** `object`<br/>|
| `providerIntegration.resourcesApi.machinePoolResources.enabled` | **Enabled** - Flag that indicates if the machine pool resources are enabled and templated.|**Type:** `boolean`<br/>**Default:** `true`|
| `providerIntegration.resourcesApi.machinePoolResources.externalAutoscaler` | **External autoscaler** - Configuration for external autoscaler.|**Type:** `object`<br/>|
| `providerIntegration.resourcesApi.machinePoolResources.externalAutoscaler.enabled` | **Enabled** - Flag that indicates if an external (to CAPI) autoscaler is used.|**Type:** `boolean`<br/>**Default:** `true`|
...
| `providerIntegration.workers.kubeadmConfig.postKubeadmCommandsTemplateName` | **Post-kubeadm commands template name** - The name of the Helm template that renders additional provider-specific commands to run after kubeadm on worker nodes. The template is rendered once per node pool. It must render a YAML list of strings, one command per item.|**Type:** `string`<br/>|
...
| `providerIntegration.workers.kubeadmConfig.preKubeadmCommandsTemplateName` | **Pre-kubeadm commands template name** - The name of the Helm template that renders additional provider-specific commands to run before kubeadm on worker nodes. The template is rendered once per node pool. It must render a YAML list of strings, one command per item.|**Type:** `string`<br/>|
